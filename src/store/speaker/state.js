export default {
  speakers: [
    ...
    },
    {
      ...
      name: 'La belle démocratie',
      bio: 'Engagement citoyen, démocratie participative, gouvernance partagée, recours aux outils d’intelligence collective pour co-construire les projets, transparence des débats, écoute mutuelle, bienveillance, convivialité et… impertinence. <br/><br/>La Belle Démocratie veut montrer que chacun, en particulier au niveau local, peut apporter sa pierre au renouveau de l’édifice commun en levant les blocages et en dépassant les oppositions qui continuent encore trop souvent de s’attacher à la façon de faire de la politique.' +
        ' La Belle Démocratie a définit collectivement <strong>deux raisons d’être</strong>, lors de la réunion plénière de Crest les 26 et 27 mai 2018 :<br/>' +
        '<br/>' +
    ...
    },
    {
      ...
      name: 'Tous Elus',
      bio: 'Tous Elus est un mouvement sans couleur politique lancé par une poignée de citoyen·nes au printemps 2018.<br/>' +
        '<br/>' +
        'Notre objectif ? Ré-oxygéner notre démocratie en accompagnant des milliers de jeunes citoyen·nes, notamment issu·es des zones rurales et péri-urbaines, pour qu’elles·ils s’investissent en politique pour défendre leur vision de la société et faire entendre leur voix !<br/>' +
        '<br/>' +
    ...
    },
    {
      ...
      name: 'Des communes & des citoyens',
      bio: 'C\'est au service du bien collectif que nous sommes engagés, avec ces milliers de bénévoles associatifs et de conseillers municipaux qui tiennent aujourd\'hui notre France à bout de bras, dans un contexte de crise sans précédent.<br/>' +
        '<br/>' +
